...
import { withUser, withTimer } from "../../hoc";
...
class _TwitterCardClass extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="card" onClick={resetTimer}>
        <div className="user-info-container">
          <div className="username">
          <img src={TwitterCircleIcon} alt="Twitter icon" />

            <div className="username-info">
              <div>
                <h1>{user.name} - {type}</h1>
                <svg
                  height="20"
                  viewBox="0 0 512 512"
                  width="20"
...
export const TwitterCardClass = compose(
  withTimer(15),
  withUser()
)(_TwitterCardClass);
